...
pygame.mixer.music.set_volume(0.5)  #valores entre 0 e 1
background_music = pygame.mixer.music.load('BoxCat Games - CPU Talk.mp3')
pygame.mixer.music.play(-1)

## tirando a música de fundo, todos os outros arquivos precisam ser .wav
...
while True:
    ...
    clock.tick(speed)  #o jogo atualiza a cada 1seg
    #quadros por segundo, continuidade da tela